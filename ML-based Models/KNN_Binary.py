...
print("Starting improved KNN model training and evaluation for binary classification (labels 1 and -1)...")
...
# Filter out any rows with label 0 to ensure only labels -1 and 1 remain
...
###############################
# Step 3: Build a Pipeline and Tune Hyperparameters
###############################
